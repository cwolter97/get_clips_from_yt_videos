...
def download_video(video_url,quality,download_path):
	# TODO: Complete quality_order list. Make hybrid that will download higher quality video then combine audio
	# to accomplish higher quality downloads. 
	...
	found_quality = False
	while not found_quality and quality_index < len(quality_order):
		for v in yt:
...
def main():
	# TODO: Add threading to speed up when downloading multiple videos
